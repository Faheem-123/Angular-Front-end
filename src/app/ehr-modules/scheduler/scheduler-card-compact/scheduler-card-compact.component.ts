...
@Component({
  selector: 'scheduler-card-compact',
  templateUrl: './scheduler-card-compact.component.html',
  styleUrls: ['./scheduler-card-compact.component.css']
})
export class SchedulerCardCompactComponent implements OnInit {
